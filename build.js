...
},{"es6-template-strings":41}],3:[function(require,module,exports){
"use strict"
...
},{"es5-ext/object/assign":19,"es5-ext/object/is-callable":22,"es5-ext/object/normalize-options":27,"es5-ext/string/#/contains":31}],5:[function(require,module,exports){
...
},{"../../function/is-arguments":11,"../../function/is-function":12,"../../number/to-pos-integer":18,"../../object/is-value":23,"../../object/valid-callable":29,"../../object/valid-value":30,"../../string/is-string":34,"es6-symbol":35}],11:[function(require,module,exports){
"use strict";
...
},{"../keys":24,"../valid-value":30}],22:[function(require,module,exports){
// Deprecated
...
},{"../function/noop":13}],24:[function(require,module,exports){
"use strict";
...
},{"../is-value":23}],27:[function(require,module,exports){
"use strict";
...
},{"./is-value":23}],28:[function(require,module,exports){
"use strict";
...
},{"./is-value":23}],31:[function(require,module,exports){
"use strict";
...
},{"./is-implemented":36,"./polyfill":38}],36:[function(require,module,exports){
'use strict';
...
},{"./validate-symbol":39,"d":4}],39:[function(require,module,exports){
'use strict';
...
},{"./is-symbol":37}],40:[function(require,module,exports){
'use strict';
...
},{"esniff":45}],41:[function(require,module,exports){
'use strict';
...
},{"./compile":40,"./resolve-to-string":43}],42:[function(require,module,exports){
'use strict';
...
},{"./passthru":42,"./resolve":44}],44:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/normalize-options":27,"es5-ext/object/valid-value":30,"esniff/is-var-name-valid":46}],45:[function(require,module,exports){
'use strict';
...
},{"./lib/ws":49,"./lib/ws-eol":47,"d":4,"es5-ext/array/from":8,"es5-ext/object/primitive-set":28,"es5-ext/object/valid-callable":29,"es5-ext/object/valid-value":30}],46:[function(require,module,exports){
...
},{"es5-ext/array/from":8,"es5-ext/object/primitive-set":28}],48:[function(require,module,exports){
'use strict';
...
},{"es5-ext/array/from":8,"es5-ext/object/primitive-set":28}],49:[function(require,module,exports){
'use strict';
...
},{"./ws-eol":47,"./ws-inline":48,"es5-ext/object/primitive-set":28}],50:[function(require,module,exports){
...
class ChildEntityCache {
  ...
  addChild(parentNetworkId, childData) {
    NAF.log.write('adding ', childData);
...
class NetworkEntities {
  ...
  createRemoteEntity(entityData) {
    console.log('WTF? Creating remote entity', entityData);
    ...
    var isBox =  (template === "#box-template");
    console.log('template is' ,template, (template === "#box-template"));
  ...
  addNetworkComponent(entity, entityData) {
    var networkData = {
      ...
      appendAsChildOf: entityData.appendAsChildOf,
    };
  ...
  updateEntity(client, dataType, entityData) {
    ...
    NAF.log.write('updateEntity NAF');
  ...
  receiveFirstUpdateFromEntity(entityData) {
    ...
    var networkId = entityData.networkId;
    console.log('good stuff entitydata', entityData);
    var parentNotCreatedYet = parent && !this.hasEntity(parent);

    var shouldPlaceWithMarker = entityData.template === "#box-template";

    NAF.log.write(parentNotCreatedYet, 'receiveFirstUpdateFromEntity, hasparent ', !parentNotCreatedYet, parent );    
    ...
    if (parentNotCreatedYet) {
      ...
      this.addEntityToPage(remoteEntity, parent, shouldPlaceWithMarker);
    }
  }
  ...
  //todo: if ar, add as child to marker
  addEntityToPage(entity, parentId, shouldPlaceWithMarker) {
    NAF.log.write('add entity to page', entity, parentId, shouldPlaceWithMarker);

    if (this.hasEntity(parentId)) {
      this.addEntityToParent(entity, parentId);
    } else {
      shouldPlaceWithMarker ? this.addEntityToMarker(entity) : this.addEntityToSceneRoot(entity);
    }
  }

  addEntityToParent(entity, parentId) {
    var parentEl = document.getElementById('naf-' + parentId);
    NAF.log.write('adding ', entity, ' to parent ', parentEl);            
    parentEl.appendChild(entity);
  }

  addEntityToMarker(entity) {
    var parentEl = document.getElementById('marker');
    NAF.log.write('adding ', entity, ' to marker parent: ', parentEl); 
    NAF.log.write('this is ', this);
    var el = document.querySelector('#marker');
    var groupObject3D = el.object3D;
   // console.log(groupObject3D.parent);
   // console.log(groupObject3D.children);
    console.log('marker children: ', groupObject3D.children, 'length', groupObject3D.children.length);
    
    if (groupObject3D.children.length <= 2) {
      parentEl.appendChild(entity);    
    }
  }

  addEntityToSceneRoot(el) {
    NAF.log.write('adding ', el, ' to scene root');    
...
class EasyRtcAdapter extends INetworkAdapter {
  ...
  setWebRtcOptions(options) {
    ...
    this.easyrtc.enableVideoReceive(options.videp);
  ...
  connect() {
    ...
    if(this.easyrtc.videoEnabled) {
      console.log('trying connect w video');
      this._connectWithVideo(connectedCallback, this.connectFailure);
    }
  ...
  startStreamConnection(clientId) {
    naf.log.write('Starting stream connection to ', clientId);    
    this.easyrtc.call(clientId,
      function(caller, media) {
        naf.log.write('Starting stream of type ', media);                  
        if (media === 'datachannel') {
          naf.log.write('Successfully started datachannel to ', caller);
        } else if (media === 'audiovideo') {
          naf.log.write('Successfully started audiovideo channel to ', caller);          
        } else {
          console.log(media);
        }
      },
  ...
  _connectWithVideo(connectSuccess, connectFailure) {
    ...
    this.easyrtc.setStreamAcceptor(function(easyrtcid, stream, streamName) {
      console.log('in stream acceptor really tho', streamName, stream);
       var assets = document.getElementsByTagName('a-assets')[0];
      var scene = document.getElementsByTagName('a-scene')[0];
      
      var videoEl = document.createElement("video");
      videoEl.setAttribute('id', 'video-' + easyrtcid);
      //videoEl.setAttribute('autoplay', true);
      assets.appendChild(videoEl);
      that.easyrtc.setVideoObjectSrc(videoEl, stream);

      // scene.appendChild(videoEl);
      //var video = document.getElementsByTagName('a-video')[0];
      var video = document.createElement("a-video");
      
      //var aframeVideoEl = document.createElement("a-video");
     //video.setAttribute('src', 'video-' + easyrtcid);
     video.setAttribute('autoplay', true);
     video.setAttribute('material', 'src: #video-' +easyrtcid +';'); // SUCCESS?
     that.easyrtc.setVideoObjectSrc(video, stream);
     scene.appendChild(video);

      
      // var scene = document.getElementsByTagName('a-scene')[0];
      
      // var videoAframeEl = document.createElement("a-video");
      // //videoAframeEl.setAttribute('src', '#video-' + easyrtcid);
      // videoAframeEl.setAttribute('id', 'video-aframe-' + easyrtcid);   
      // videoAframeEl.setAttribute('width', '16');
      // videoAframeEl.setAttribute('height', '9');
      // videoAframeEl.setAttribute('position', '0 1 -2');

      // scene.appendChild(videoAframeEl);
      //  that.easyrtc.setVideoObjectSrc(videoAframeEl, stream);

      
    });

    this.easyrtc.setOnStreamClosed(function (easyrtcid) {
      var videoAframeEl = document.getElementById('video-aframe-' +easyrtcid);
      videoAframeEl.parentNode.removeChild(videoAframeEl);
      
      var videoEl = document.getElementById('video-' + easyrtcid);
...
AFRAME.registerComponent('networked-scene', {
  ...
  connect: function () {
    ...
    NAF.connection.connect(this.data.serverURL, this.data.app, this.data.room, this.data.audio, this.data.video);
  },
...
AFRAME.registerComponent('networked', {
  ...
  init: function() {
    ...
    console.log('networked thing init ', this, data, wasCreatedByNetwork);
  ...
  attachAndShowTemplate: function(template, show) {
    console.log('in attach and show template');
    var el = this.el;
    var data = this.data;
  ...
  firstUpdate: function() {
    console.log('first update of ', this.el);
